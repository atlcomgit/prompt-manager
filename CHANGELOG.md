...
- Bound chat sessions are now renamed again after a prompt title or task number change, and the rename flow can still resolve the prompt through promptUuid after the prompt id changes.
