...
const panelBorder = '1px solid color-mix(in srgb, var(--vscode-foreground) 8%, transparent)';

// Стили графа знаний — плоский дизайн, тонкие рамки, чистые контролы.
const styles: Record<string, React.CSSProperties> = {
	...
	body: { flex: 1, display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 320px', gap: '14px', minHeight: 0 },
	bodyOverview: { flex: 1, display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', gap: '14px', minHeight: 0 },
	sceneWrap: {
		position: 'relative',
		minHeight: 0,
		borderRadius: '12px',
	...
	emptyOverlayTitle: { fontSize: '14px', fontWeight: 800, letterSpacing: '-0.01em' },
	emptyOverlayText: { fontSize: '12px', lineHeight: 1.55, color: 'var(--vscode-descriptionForeground)' },
	minimap: {
		position: 'absolute',
		right: '14px',
		bottom: '14px',
	...
	inspectorHeader: { fontSize: '10px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--vscode-descriptionForeground)' },
	panelSection: { display: 'flex', flexDirection: 'column', gap: '10px', padding: '12px', borderRadius: '10px', border: panelBorder, background: 'color-mix(in srgb, var(--vscode-foreground) 2%, transparent)' },
	entityTitle: { fontSize: '15px', fontWeight: 800, lineHeight: 1.35, wordBreak: 'break-word', letterSpacing: '-0.01em' },
	badges: { display: 'flex', gap: '6px', flexWrap: 'wrap' },
	badge: { padding: '3px 7px', borderRadius: '6px', background: 'color-mix(in srgb, var(--vscode-button-background) 12%, transparent)', color: 'var(--vscode-foreground)', fontSize: '10px', lineHeight: 1.2, fontWeight: 700 },
	...
	sectionTitle: { fontSize: '10px', fontWeight: 700, color: 'var(--vscode-descriptionForeground)', textTransform: 'uppercase', letterSpacing: '0.04em' },
	pillList: { display: 'flex', gap: '6px', flexWrap: 'wrap' },
	pill: { padding: '4px 8px', borderRadius: '6px', background: 'color-mix(in srgb, var(--vscode-foreground) 4%, transparent)', border: panelBorder, fontSize: '11px', lineHeight: 1.25, maxWidth: '100%', wordBreak: 'break-word' },
	placeholder: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', fontSize: '12px', color: 'var(--vscode-descriptionForeground)', padding: '12px' },
	empty: { height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', color: 'var(--vscode-descriptionForeground)', fontSize: '12px' },
	error: { height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', color: 'var(--vscode-errorForeground)', background: 'color-mix(in srgb, var(--vscode-errorForeground) 6%, transparent)', borderRadius: '12px', border: '1px solid color-mix(in srgb, var(--vscode-errorForeground) 14%, transparent)' },
};